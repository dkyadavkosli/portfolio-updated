...
function About() {
  ...
  const education = [
    ...
    {
      institution: "Rao Pahlad Singh School, Mahendergarh",
      degree: "12th Class",
      duration: "2019-2020",
    },
    {
          ...
          <section className="space-y-6">
            ...
            >
              <h4 className="text-start text-slate-200 text-lg leading-relaxed font-light mb-6">
                A dedicated web and blockchain developer passionate about
                delving deeper into the world of Web3 and crafting intuitive,
          ...
          <section className="space-y-6">
            ...
            >
              ...
              <div className="space-y-4 text-slate-300 text-sm leading-relaxed">
                <p className="text-start">
                  Growing up in a quaint village in India, I was surrounded by
                  an environment brimming with positivity and motivation. With
                  both my parents being dedicated teachers, they ensured I
                  excelled in my studies. Although my initial exposure to
                  technology was limited, my curiosity grew over time, sparking
                  a deep interest in computers.
                </p>
                <p className="text-start">
                  During my school years, my passion for sports shone brightly.
                  I competed at the state level in Volleyball for the under-14
                  category, excelled in Throwball for the under-16 category, and
                  showcased my talent in Cricket at the state level for the
                  under-16 category.
                </p>
                <p className="text-start">
                  My true interaction with emerging technologies began in
                  college, where I discovered various tech stacks and the
                  fascinating world of blockchain. Today, I harness my technical
                  skills to craft user-friendly web applications.
                </p>
              </div>
            </motion.article>
            ...
            >
              ...
              <div className="space-y-3">
                ...
                <div className="rounded-lg overflow-hidden">
                  <iframe
                    src="https://open.spotify.com/embed/track/0w1qgN9ZbInXLIzAPEcMoI?utm_source=generator&theme=0"
                    width="100%"
                    height="102"
                    frameBorder="0"
                    allowFullScreen=""
              ...
              <div className="space-y-6">
                {education.map((edu, index) => (
                  ...
                  >
                    ...
                    <h3 className="text-slate-200 font-medium mb-1 text-sm">
                      {edu.institution}
                    </h3>
                    <p className="text-green-400 font-semibold text-sm mb-1">
                      {edu.degree}
