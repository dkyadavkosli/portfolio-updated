            ...
            <div className="relative z-10 max-w-5xl mx-auto">
                ...
                >
                    ...
                    <div className='bg-gradient-to-br from-slate-900/60 to-slate-800/40 backdrop-blur-sm border border-slate-700/50 rounded-2xl p-8 md:p-10 shadow-xl hover:shadow-2xl transition-all duration-300'>
                        ...
                        >
                            I am a proficient software developer, expertly versed in <span className="text-white font-medium">TypeScript</span> and <span className="text-white font-medium">JavaScript</span>,
                            with a strong command of frameworks such as <span className="text-white font-medium">React</span>, <span className="text-white font-medium">Node.js</span>, and <span className="text-white font-medium">Next.js</span>.
                            My robust problem-solving skills are complemented by an extensive understanding
                            of diverse <span className="text-white font-medium">Data Structures and Algorithms</span>. Additionally, I possess the capability
                            to develop cutting-edge <span className="text-white font-medium">Decentralized Web Applications (DApps)</span> utilizing <span className="text-white font-medium">Smart Contracts</span>, <span className="text-white font-medium">Web3.js</span>, and <span className="text-white font-medium">Ether.js</span>.
                        </motion.p>
                        ...
                        >
                            Beyond my technical expertise, I am a <span className="text-white font-medium">state-level cricket and volleyball player</span>, as well as an <span className="text-white font-medium">esports athlete</span>.
                            I have a passion for <span className="text-white font-medium">astronomy</span> and enjoy immersing myself in captivating documentaries.
                        </motion.p>
                    </div>
                    ...
                    >
                        <motion.a
                            href='https://drive.google.com/file/d/1NDEGdHq2FQ067xkk6adF3MXRkIj7g8oC/view?usp=sharing'
                            target='_blank'
